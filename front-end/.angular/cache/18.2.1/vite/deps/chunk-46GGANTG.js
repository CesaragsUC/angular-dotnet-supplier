...
var Attribute, Property, parseCache, EventType, MOUSE_SPECIAL_EVENT_TYPES, BUBBLE_EVENT_TYPES, CAPTURE_EVENT_TYPES, isCaptureEventType, EARLY_EVENT_TYPES, isEarlyEventType, MAC_ENTER, ENTER, SPACE, KeyCode, isMac, isWebKit, isIe, isGecko, ACTION_KEY_TO_KEYCODE, IDENTIFIER_TO_KEY_TRIGGER_MAPPING, isIos, EventContractContainer, Char, EventInfoWrapper, EMPTY_ACTION_MAP, REGEXP_SEMICOLON, DEFAULT_EVENT_TYPE, ActionResolver, Restriction, Dispatcher, PROPAGATION_STOPPED_SYMBOL, EventPhase, PREVENT_DEFAULT_ERROR_MESSAGE_DETAILS, PREVENT_DEFAULT_ERROR_MESSAGE, COMPOSED_PATH_ERROR_MESSAGE_DETAILS, COMPOSED_PATH_ERROR_MESSAGE, EventDispatcher, MOUSE_SPECIAL_SUPPORT, _EventContract, EventContract;
var init_event_dispatch = __esm({
  "node_modules/@angular/core/fesm2022/primitives/event-dispatch.mjs"() {
    ...
    MOUSE_SPECIAL_EVENT_TYPES = [EventType.MOUSEENTER, EventType.MOUSELEAVE, "pointerenter", "pointerleave"];
    BUBBLE_EVENT_TYPES = [
      EventType.CLICK,
      EventType.DBLCLICK,
      EventType.FOCUSIN,
    ...
    CAPTURE_EVENT_TYPES = [EventType.FOCUS, EventType.BLUR, EventType.ERROR, EventType.LOAD, EventType.TOGGLE];
    ...
    isWebKit = typeof navigator !== "undefined" && !/Opera/.test(navigator.userAgent) && /WebKit/.test(navigator.userAgent);
    isIe = typeof navigator !== "undefined" && (/MSIE/.test(navigator.userAgent) || /Trident/.test(navigator.userAgent));
    isGecko = typeof navigator !== "undefined" && !/Opera|WebKit/.test(navigator.userAgent) && /Gecko/.test(navigator.product);
    ACTION_KEY_TO_KEYCODE = {
      "Enter": KeyCode.ENTER,
      " ": KeyCode.SPACE
    };
    IDENTIFIER_TO_KEY_TRIGGER_MAPPING = {
      "A": KeyCode.ENTER,
      "BUTTON": 0,
    ...
    PROPAGATION_STOPPED_SYMBOL = Symbol.for("propagationStopped");
    EventPhase = {
      REPLAY: 101
    };
    ...
    _EventContract = class _EventContract {
...
__export(core_exports, {
  ...
  ɵGLOBAL_EVENT_DELEGATION: () => GLOBAL_EVENT_DELEGATION,
  ...
  ɵprovideGlobalEventDelegation: () => provideGlobalEventDelegation,
...
var ERROR_DETAILS_PAGE_BASE_URL, XSS_SECURITY_URL, RuntimeError, REQUIRED_UNSET_VALUE, INPUT_SIGNAL_NODE, ɵINPUT_SIGNAL_BRAND_READ_TYPE, ɵINPUT_SIGNAL_BRAND_WRITE_TYPE, ANNOTATIONS, PARAMETERS, PROP_METADATA, _global, __forward_ref__, defineInjectable, NG_PROV_DEF, NG_INJ_DEF, NG_INJECTABLE_DEF, NG_INJECTOR_DEF, InjectionToken, _injectorProfilerContext, injectorProfilerCallback, setInjectorProfiler, NG_COMP_DEF, NG_DIR_DEF, NG_PIPE_DEF, NG_MOD_DEF, NG_FACTORY_DEF, NG_ELEMENT_ID, NG_ENV_ID, InjectFlags, _injectImplementation, _THROW_IF_NOT_FOUND, THROW_IF_NOT_FOUND, DI_DECORATOR_FLAG, NG_TEMP_TOKEN_PATH, NG_TOKEN_PATH, NEW_LINE, NO_NEW_LINE, SOURCE, _currentInjector, Inject, Optional, Self, SkipSelf, Host, EMPTY_OBJ, EMPTY_ARRAY, ENVIRONMENT_INITIALIZER, INJECTOR$1, INJECTOR_DEF_TYPES, NullInjector, ChangeDetectionStrategy, ViewEncapsulation$1, InputFlags, NG_TEMPLATE_SELECTOR, GENERATED_COMP_IDS, USE_VALUE$1, INJECTOR_SCOPE, NOT_YET, CIRCULAR, NULL_INJECTOR, EnvironmentInjector, R3Injector, FactoryTarget, R3TemplateDependencyKind, ViewEncapsulation, angularCoreDiEnv, Type, ES5_DELEGATE_CTOR, ES2015_INHERITED_CLASS, ES2015_INHERITED_CLASS_WITH_CTOR, ES2015_INHERITED_CLASS_WITH_DELEGATE_CTOR, ReflectionCapabilities, HOST, TVIEW, FLAGS, PARENT, NEXT, T_HOST, HYDRATION, CLEANUP, CONTEXT, INJECTOR, ENVIRONMENT, RENDERER, CHILD_HEAD, CHILD_TAIL, DECLARATION_VIEW, DECLARATION_COMPONENT_VIEW, DECLARATION_LCONTAINER, PREORDER_HOOK_FLAGS, QUERIES, ID, EMBEDDED_VIEW_INJECTOR, ON_DESTROY_HOOKS, EFFECTS_TO_SCHEDULE, REACTIVE_TEMPLATE_CONSUMER, HEADER_OFFSET, TYPE, DEHYDRATED_VIEWS, NATIVE, VIEW_REFS, MOVED_VIEWS, CONTAINER_HEADER_OFFSET, LContainerFlags, SimpleChange, SIMPLE_CHANGES_STORE, profilerCallback, setProfiler, profiler, SVG_NAMESPACE, MATH_ML_NAMESPACE, instructionState, CheckNoChangesMode, _checkNoChangesMode, _isRefreshingViews, leaveDI, _wasLastNodeCreated, NO_PARENT_INJECTOR, NodeInjectorFactory, NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR, ChainedInjector, includeViewProviders, BLOOM_SIZE, BLOOM_MASK, BLOOM_BUCKET_BITS, nextNgElementId, NOT_FOUND, NodeInjector, Attribute2, _reflect, USE_VALUE, Injectable, _Injector, Injector, HostAttributeToken, HOST_TAG_NAME, ERROR_ORIGINAL_ERROR, SCHEDULE_IN_ROOT_ZONE_DEFAULT, _DestroyRef, DestroyRef, NodeInjectorDestroyRef, _PendingTasks, PendingTasks, _ExperimentalPendingTasks, ExperimentalPendingTasks, EventEmitter_, EventEmitter, AsyncStackTaggingZoneSpec, isAngularZoneProperty, angularZoneInstanceIdProperty, ngZoneInstanceId, NgZone, EMPTY_PAYLOAD, NoopNgZone, ErrorHandler, INTERNAL_APPLICATION_ERROR_HANDLER, OutputEmitterRef, input, _ElementRef, ElementRef, _QueryList, QueryList, SKIP_HYDRATION_ATTR_NAME, SKIP_HYDRATION_ATTR_NAME_LOWER_CASE, TRACKED_LVIEWS, uniqueIdCounter, LContext, MONKEY_PATCH_KEY_NAME, DOCUMENT, APP_ID, DEFAULT_APP_ID, PLATFORM_INITIALIZER, PLATFORM_ID, PACKAGE_ROOT_URL, ANIMATION_MODULE_TYPE, CSP_NONCE, IMAGE_CONFIG_DEFAULTS, IMAGE_CONFIG, _TransferState, TransferState, REFERENCE_NODE_HOST, REFERENCE_NODE_BODY, NodeNavigationStep, ELEMENT_CONTAINERS, TEMPLATES, CONTAINERS, MULTIPLIER, NUM_ROOT_NODES, TEMPLATE_ID, NODES, DISCONNECTED_NODES, I18N_DATA, TRANSFER_STATE_TOKEN_ID, NGH_DATA_KEY, NGH_ATTR_NAME, SSR_CONTENT_INTEGRITY_MARKER, _retrieveHydrationInfoImpl, HydrationStatus, HYDRATION_INFO_KEY, IS_HYDRATION_DOM_REUSE_ENABLED, PRESERVE_HOST_CONTENT_DEFAULT, PRESERVE_HOST_CONTENT, IS_I18N_HYDRATION_ENABLED, IS_EVENT_REPLAY_ENABLED, EVENT_REPLAY_ENABLED_DEFAULT, IS_GLOBAL_EVENT_DELEGATION_ENABLED, policy$1, policy, SafeValueImpl, SafeHtmlImpl, SafeStyleImpl, SafeScriptImpl, SafeUrlImpl, SafeResourceUrlImpl, DOMParserHelper, InertDocumentHelper, SAFE_URL_PATTERN, VOID_ELEMENTS, OPTIONAL_END_TAG_BLOCK_ELEMENTS, OPTIONAL_END_TAG_INLINE_ELEMENTS, OPTIONAL_END_TAG_ELEMENTS, BLOCK_ELEMENTS, INLINE_ELEMENTS, VALID_ELEMENTS, URI_ATTRS, HTML_ATTRS, ARIA_ATTRS, VALID_ATTRS, SKIP_TRAVERSING_CONTENT_IF_INVALID_ELEMENTS, SanitizingHtmlSerializer, SURROGATE_PAIR_REGEXP, NON_ALPHANUMERIC_REGEXP, inertBodyHelper, SecurityContext, COMMENT_DISALLOWED, COMMENT_DELIMITER, COMMENT_DELIMITER_ESCAPED, CAMEL_CASE_REGEXP, CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA, shouldThrowErrorOnUnknownElement, shouldThrowErrorOnUnknownProperty, KNOWN_CONTROL_FLOW_DIRECTIVES, INTERPOLATION_DELIMITER, VALUE_STRING_LENGTH_LIMIT, RendererStyleFlags2, _icuContainerIterate, _getInsertInFrontOfRNodeWithI18n, _processI18nInsertBefore, NO_CHANGE, _applyRootElementTransformImpl, freeConsumers, REACTIVE_LVIEW_CONSUMER_NODE, TEMPORARY_CONSUMER_NODE, MAXIMUM_REFRESH_RERUNS$1, ViewRef$1, _TemplateRef, TemplateRef, ViewEngineTemplateRef, R3TemplateRef, AT_THIS_LOCATION, internalAttrs, REF_EXTRACTOR_REGEXP, _isI18nHydrationSupportEnabled, _prepareI18nBlockForHydrationImpl, _claimDehydratedIcuCaseImpl, _findMatchingDehydratedViewImpl, ChangeDetectionScheduler, ZONELESS_ENABLED, PROVIDED_ZONELESS, ZONELESS_SCHEDULER_DISABLED, SCHEDULE_IN_ROOT_ZONE, ComponentRef$1, ComponentFactory$1, ERROR_COMPONENT, _NullComponentFactoryResolver, _ComponentFactoryResolver$1, ComponentFactoryResolver$1, RendererFactory2, _Renderer2, Renderer2, _Sanitizer, Sanitizer, markedFeatures, AfterRenderPhase, NOOP_AFTER_RENDER_REF, AfterRenderCallback, AfterRenderCallbackHandlerImpl, _AfterRenderEventManager, AfterRenderEventManager, USE_RUNTIME_DEPS_TRACKER_FOR_JIT, DepsTracker, depsTracker, ComponentFactoryResolver, ComponentFactory, ComponentRef, _ViewContainerRef, ViewContainerRef, VE_ViewContainerRef, R3ViewContainerRef, _locateOrCreateAnchorNode, _populateDehydratedViewsInLContainer, LQuery_, LQueries_, TQueryMetadata_, TQueries_, TQuery_, ɵWRITABLE_SIGNAL, viewChild, contentChild, model, emitDistinctChangesOnlyDefaultValue, Query, ContentChildren, ContentChild, ViewChildren, ViewChild, componentResourceResolutionQueue, componentDefPendingResolution, modules, checkForDuplicateNgModules, COPY_DIRECTIVE_FIELDS, COPY_COMPONENT_FIELDS, NgModuleRef$1, NgModuleFactory$1, createNgModuleRef, NgModuleRef, NgModuleFactory, EnvironmentNgModuleRefAdapter, _CachedInjectorService, CachedInjectorService, _locateOrCreateContainerAnchor, DeferDependenciesLoadingState, MINIMUM_SLOT, LOADING_AFTER_SLOT, DeferBlockState, DeferBlockInternalState, NEXT_DEFER_BLOCK_STATE, DEFER_BLOCK_STATE, STATE_IS_FROZEN_UNTIL, LOADING_AFTER_CLEANUP_FN, TRIGGER_CLEANUP_FNS, PREFETCH_TRIGGER_CLEANUP_FNS, DeferBlockBehavior, eventListenerOptions, hoverTriggers, interactionTriggers, viewportTriggers, interactionEventNames, hoverEventNames, intersectionObserver, observedViewportElements, DeferEventEntry, _requestIdleCallback, _cancelIdleCallback, _IdleScheduler, IdleScheduler, _TimerScheduler, TimerScheduler, DEFER_BLOCK_DEPENDENCY_INTERCEPTOR, DEFER_BLOCK_CONFIG, applyDeferBlockStateWithSchedulingImpl, parserState, LiveCollection, UniqueValueMultiKeyMap, RepeaterContext, RepeaterMetadata, OperationsCounter, LiveCollectionLContainerImpl, _locateOrCreateElementNode, _locateOrCreateElementContainerNode, u, localeEn, LOCALE_DATA, LocaleDataIndex, pluralMapping, DEFAULT_LOCALE_ID, USD_CURRENCY_CODE, ELEMENT_MARKER, ICU_MARKER, I18nCreateOpCode, LOCALE_ID$1, changeMask, changeMaskCounter, _locateOrCreateNode, OpCodeParser, BINDING_REGEXP, ICU_REGEXP, NESTED_ICU, ICU_BLOCK_REGEXP, MARKER, SUBTEMPLATE_REGEXP, PH_REGEXP, NGSP_UNICODE_REGEXP, ROOT_TEMPLATE_ID, PP_MULTI_VALUE_PLACEHOLDERS_REGEXP, PP_PLACEHOLDERS_REGEXP, PP_ICU_VARS_REGEXP, PP_ICU_PLACEHOLDERS_REGEXP, PP_ICUS_REGEXP, PP_CLOSE_TEMPLATE_REGEXP, PP_TEMPLATE_ID_REGEXP, stashEventListener, _locateOrCreateTextNode, UNINITIALIZED_LET, _StandaloneService, StandaloneService, ASYNC_COMPONENT_METADATA_FN, angularCoreEnv, jitOptions, moduleQueue, flushingModuleQueue, ownerNgModule, verifiedNgModule, compilationDepth, LIFECYCLE_HOOKS, Directive, Component, Pipe, Input, Output, HostBinding, HostListener, NgModule, Version, VERSION, _Console, Console, DIDebugData, frameworkDIDebugData, GLOBAL_PUBLISH_EXPANDO_KEY, globalUtilsFunctions, _published, TESTABILITY, TESTABILITY_GETTER, _Testability, Testability, _TestabilityRegistry, TestabilityRegistry, _testabilityGetter, APP_INITIALIZER, _ApplicationInitStatus, ApplicationInitStatus, APP_BOOTSTRAP_LISTENER, NgProbeToken, MAXIMUM_REFRESH_RERUNS, _ApplicationRef, ApplicationRef, whenStableStore, ModuleWithComponentFactories, _Compiler, Compiler, COMPILER_OPTIONS, CompilerFactory, _NgZoneChangeDetectionScheduler, NgZoneChangeDetectionScheduler, PROVIDED_NG_ZONE, _ZoneStablePendingTask, ZoneStablePendingTask, CONSECUTIVE_MICROTASK_NOTIFICATION_LIMIT, consecutiveMicrotaskNotifications, stackFromLastFewNotifications, _ChangeDetectionSchedulerImpl, ChangeDetectionSchedulerImpl, LOCALE_ID, DEFAULT_CURRENCY_CODE, TRANSLATIONS, TRANSLATIONS_FORMAT, MissingTranslationStrategy, SCAN_DELAY, OVERSIZED_IMAGE_TOLERANCE, _ImagePerformanceWarning, ImagePerformanceWarning, PLATFORM_DESTROY_LISTENERS, _PlatformRef, PlatformRef, _platformInjector, ALLOW_MULTIPLE_PLATFORMS, DebugNgZoneForCheckNoChanges, _ChangeDetectorRef, ChangeDetectorRef, ViewRef, EmbeddedViewRef, DebugEventListener, DebugNode, DebugElement, NG_DEBUG_PROPERTY, DefaultIterableDifferFactory, trackByIdentity, DefaultIterableDiffer, IterableChangeRecord_, _DuplicateItemRecordList, _DuplicateMap, DefaultKeyValueDifferFactory, DefaultKeyValueDiffer, KeyValueChangeRecord_, _IterableDiffers, IterableDiffers, _KeyValueDiffers, KeyValueDiffers, keyValDiff, iterableDiff, defaultIterableDiffers, defaultKeyValueDiffers, platformCore, _ApplicationModule, ApplicationModule, activeConsumer2, SIGNAL2, REACTIVE_NODE2, UNSET2, COMPUTING2, ERRORED2, COMPUTED_NODE2, SIGNAL_NODE2, NOOP_CLEANUP_FN2, WATCH_NODE2, sharedStashFunction, removeListeners, JSACTION_EVENT_CONTRACT, GLOBAL_EVENT_DELEGATION, _GlobalEventDelegation, GlobalEventDelegation, initGlobalEventDelegation, jsactionSet, initEventReplay, SerializedViewCollection, tViewSsrId, isHydrationSupportEnabled, isI18nHydrationRuntimeSupportEnabled, APPLICATION_IS_STABLE_TIMEOUT, APP_EFFECT_SCHEDULER, _EffectScheduler, EffectScheduler, ZoneAwareEffectScheduler, EffectHandle;
var init_core = __esm({
  "node_modules/@angular/core/fesm2022/core.mjs"() {
    init_signals();
    init_esm5();
    ...
    REQUIRED_UNSET_VALUE = Symbol("InputSignalNode#UNSET");
    INPUT_SIGNAL_NODE = (() => {
    ...
    ɵINPUT_SIGNAL_BRAND_READ_TYPE = Symbol();
    ɵINPUT_SIGNAL_BRAND_WRITE_TYPE = Symbol();
    ...
    NG_ENV_ID = getClosureSafeProperty({
    ...
    _PendingTasks = class _PendingTasks {
      constructor() {
        this.taskId = 0;
    ...
    _ExperimentalPendingTasks = class _ExperimentalPendingTasks {
      constructor() {
    ...
    ExperimentalPendingTasks = _ExperimentalPendingTasks;
    ...
    _TransferState = class _TransferState {
      constructor() {
        this.store = {};
    ...
    IS_GLOBAL_EVENT_DELEGATION_ENABLED = new InjectionToken(typeof ngDevMode === "undefined" || !!ngDevMode ? "IS_GLOBAL_EVENT_DELEGATION_ENABLED" : "");
    SafeValueImpl = class {
    ...
    KNOWN_CONTROL_FLOW_DIRECTIVES = /* @__PURE__ */ new Map([["ngIf", "NgIf"], ["ngFor", "NgFor"], ["ngSwitchCase", "NgSwitchCase"], ["ngSwitchDefault", "NgSwitchDefault"]]);
    ...
    NO_CHANGE = typeof ngDevMode === "undefined" || ngDevMode ? {
      __brand__: "NO_CHANGE"
    } : {};
    ...
    _TemplateRef = class _TemplateRef {
    };
    ...
    ZONELESS_ENABLED = new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "Zoneless enabled" : "", {
      providedIn: "root",
      factory: () => false
    });
    PROVIDED_ZONELESS = new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "Zoneless provided" : "", {
      providedIn: "root",
      factory: () => false
    });
    ...
    _ComponentFactoryResolver$1 = class _ComponentFactoryResolver$1 {
    };
    _ComponentFactoryResolver$1.NULL = new _NullComponentFactoryResolver();
    ComponentFactoryResolver$1 = _ComponentFactoryResolver$1;
    RendererFactory2 = class {
    };
    _Renderer2 = class _Renderer2 {
      constructor() {
    ...
    _AfterRenderEventManager = class _AfterRenderEventManager {
      constructor() {
        this.handler = null;
    ...
    AfterRenderEventManager = _AfterRenderEventManager;
    ...
    _ViewContainerRef = class _ViewContainerRef {
    };
    ...
    ɵWRITABLE_SIGNAL = Symbol("WRITABLE_SIGNAL");
    viewChild = (() => {
    ...
    _CachedInjectorService = class _CachedInjectorService {
      constructor() {
    ...
    CachedInjectorService = _CachedInjectorService;
    ...
    _IdleScheduler = class _IdleScheduler {
      constructor() {
        this.executingCallbacks = false;
        this.idleId = null;
    ...
    IdleScheduler = _IdleScheduler;
    _TimerScheduler = class _TimerScheduler {
      constructor() {
        this.executingCallbacks = false;
        this.timeoutId = null;
    ...
    stashEventListener = (el, eventName, listenerFn) => {
    };
    ...
    UNINITIALIZED_LET = {};
    _StandaloneService = class _StandaloneService {
    ...
    StandaloneService = _StandaloneService;
    ...
    Component = makeDecorator("Component", (c = {}) => __spreadValues({
      changeDetection: ChangeDetectionStrategy.Default
    }, c), Directive, void 0, (type, meta) => compileComponent(type, meta));
    Pipe = makeDecorator("Pipe", (p) => __spreadValues({
      pure: true
    ...
    Output = makePropDecorator("Output", (alias) => ({
      alias
    }));
    ...
    VERSION = new Version("18.2.1");
    _Console = class _Console {
      log(message) {
        console.log(message);
      }
    ...
    _Testability = class _Testability {
    ...
    _TestabilityRegistry = class _TestabilityRegistry {
      constructor() {
    ...
    TestabilityRegistry = _TestabilityRegistry;
    (() => {
    ...
    _ApplicationInitStatus = class _ApplicationInitStatus {
      constructor() {
    ...
    ApplicationInitStatus = _ApplicationInitStatus;
    (() => {
    ...
    _ApplicationRef = class _ApplicationRef {
      constructor() {
    ...
    _NgZoneChangeDetectionScheduler = class _NgZoneChangeDetectionScheduler {
      constructor() {
        this.zone = inject(NgZone);
    ...
    NgZoneChangeDetectionScheduler = _NgZoneChangeDetectionScheduler;
    (() => {
    ...
    _ZoneStablePendingTask = class _ZoneStablePendingTask {
      constructor() {
    ...
    ZoneStablePendingTask = _ZoneStablePendingTask;
    (() => {
    ...
    _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
      constructor() {
    ...
    ChangeDetectionSchedulerImpl = _ChangeDetectionSchedulerImpl;
    (() => {
    ...
    _ImagePerformanceWarning = class _ImagePerformanceWarning {
      constructor() {
        this.window = null;
        this.observer = null;
    ...
    ImagePerformanceWarning = _ImagePerformanceWarning;
    (() => {
    ...
    _PlatformRef = class _PlatformRef {
      /** @internal */
      constructor(_injector) {
        this._injector = _injector;
        this._modules = [];
    ...
    DebugNgZoneForCheckNoChanges = class extends NgZone {
    ...
    _ChangeDetectorRef = class _ChangeDetectorRef {
    };
    ...
    _IterableDiffers = class _IterableDiffers {
    ...
    _KeyValueDiffers = class _KeyValueDiffers {
      constructor(factories) {
        this.factories = factories;
      }
      static create(factories, parent) {
    ...
    _ApplicationModule = class _ApplicationModule {
    ...
    UNSET2 = Symbol("UNSET");
    COMPUTING2 = Symbol("COMPUTING");
    ERRORED2 = Symbol("ERRORED");
    COMPUTED_NODE2 = (() => {
    ...
    GLOBAL_EVENT_DELEGATION = new InjectionToken(ngDevMode ? "GLOBAL_EVENT_DELEGATION" : "");
    _GlobalEventDelegation = class _GlobalEventDelegation {
      constructor() {
    ...
    GlobalEventDelegation = _GlobalEventDelegation;
    (() => {
    ...
    _EffectScheduler = class _EffectScheduler {
    };
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-46GGANTG.js.map
